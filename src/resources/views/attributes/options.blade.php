...
<div class="select-section {{ $class = \Str::random().'_setting' }}">
    <div class="table-responsive">
        <table id="values-table" width="100%"
            ...
            <thead>
            <tr>
                <th width="10%">@lang('utility-category::labels.attribute.order')</th>
                <th width="40%">@lang('utility-category::labels.attribute.value')</th>
                <th width="50%">@lang('utility-category::labels.attribute.display')</th>
                <th></th>
            </tr>
            </thead>
            <tbody>
    ...
    <span class="help-block">
                            @lang('utility-category::labels.attribute.add_new_option')
                        </span>
</div>
